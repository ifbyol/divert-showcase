...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DH says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dh server on %d", PORT);
});