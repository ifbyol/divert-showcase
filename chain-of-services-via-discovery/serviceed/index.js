...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service ED says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ed server on %d", PORT);
});