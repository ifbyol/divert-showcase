...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BF says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bf server on %d", PORT);
});