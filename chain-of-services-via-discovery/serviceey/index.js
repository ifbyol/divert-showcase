...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EY says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ey server on %d", PORT);
});