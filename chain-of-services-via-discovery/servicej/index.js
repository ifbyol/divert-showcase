...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service J says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-j server on %d", PORT);
});