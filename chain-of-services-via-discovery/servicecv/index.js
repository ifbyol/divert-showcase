...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CV says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cv server on %d", PORT);
});