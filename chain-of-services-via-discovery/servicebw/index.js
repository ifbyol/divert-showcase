...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BW says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bw server on %d", PORT);
});