...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service Q says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-q server on %d", PORT);
});