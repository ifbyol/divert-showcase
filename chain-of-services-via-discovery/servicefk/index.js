...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FK says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fk server on %d", PORT);
});