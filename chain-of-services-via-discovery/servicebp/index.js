...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BP says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bp server on %d", PORT);
});