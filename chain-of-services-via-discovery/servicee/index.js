...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service E says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-e server on %d", PORT);
});