...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service G says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-g server on %d", PORT);
});