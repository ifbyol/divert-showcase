...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BJ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bj server on %d", PORT);
});