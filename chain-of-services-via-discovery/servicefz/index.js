...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FZ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fz server on %d", PORT);
});