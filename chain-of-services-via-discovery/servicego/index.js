...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GO says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-go server on %d", PORT);
});