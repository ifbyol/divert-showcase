...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FF says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ff server on %d", PORT);
});