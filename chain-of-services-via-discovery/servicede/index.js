...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DE says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-de server on %d", PORT);
});