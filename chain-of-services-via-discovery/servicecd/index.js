...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CD says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cd server on %d", PORT);
});