...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CX says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cx server on %d", PORT);
});