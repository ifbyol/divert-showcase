...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BY says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-by server on %d", PORT);
});