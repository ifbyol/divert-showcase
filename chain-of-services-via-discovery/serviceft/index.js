...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FT says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ft server on %d", PORT);
});