...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CH says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ch server on %d", PORT);
});