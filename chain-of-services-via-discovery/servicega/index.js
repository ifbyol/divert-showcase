...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GA says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ga server on %d", PORT);
});