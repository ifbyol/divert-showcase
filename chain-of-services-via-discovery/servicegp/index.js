...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GP says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gp server on %d", PORT);
});