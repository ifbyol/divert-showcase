...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BK says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bk server on %d", PORT);
});