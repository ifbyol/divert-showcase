...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service N says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-n server on %d", PORT);
});