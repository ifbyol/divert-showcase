...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GN says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gn server on %d", PORT);
});