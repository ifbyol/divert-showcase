...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DA says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-da server on %d", PORT);
});