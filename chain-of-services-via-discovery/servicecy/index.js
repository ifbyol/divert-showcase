...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CY says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cy server on %d", PORT);
});