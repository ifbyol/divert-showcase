...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EO says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-eo server on %d", PORT);
});