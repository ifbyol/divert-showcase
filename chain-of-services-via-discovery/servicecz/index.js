...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CZ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cz server on %d", PORT);
});