...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BH says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bh server on %d", PORT);
});