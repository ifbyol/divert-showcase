...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service W says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-w server on %d", PORT);
});