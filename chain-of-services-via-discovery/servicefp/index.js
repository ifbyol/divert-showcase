...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FP says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fp server on %d", PORT);
});