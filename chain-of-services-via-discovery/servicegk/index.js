...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GK says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gk server on %d", PORT);
});