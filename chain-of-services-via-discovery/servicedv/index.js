...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DV says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dv server on %d", PORT);
});