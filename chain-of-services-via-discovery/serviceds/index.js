...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DS says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ds server on %d", PORT);
});