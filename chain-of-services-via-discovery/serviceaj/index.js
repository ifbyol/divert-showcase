...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AJ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-aj server on %d", PORT);
});