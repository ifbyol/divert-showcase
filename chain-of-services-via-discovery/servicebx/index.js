...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BX says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bx server on %d", PORT);
});