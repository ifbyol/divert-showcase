...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FI says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fi server on %d", PORT);
});