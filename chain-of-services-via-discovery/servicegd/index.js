...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GD says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gd server on %d", PORT);
});