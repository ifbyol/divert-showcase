...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CP says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cp server on %d", PORT);
});