...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FY says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fy server on %d", PORT);
});