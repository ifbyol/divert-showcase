...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EV says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ev server on %d", PORT);
});