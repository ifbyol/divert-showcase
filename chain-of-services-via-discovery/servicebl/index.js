...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BL says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bl server on %d", PORT);
});