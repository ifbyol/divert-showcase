...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service S says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-s server on %d", PORT);
});