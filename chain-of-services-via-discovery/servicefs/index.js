...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FS says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fs server on %d", PORT);
});