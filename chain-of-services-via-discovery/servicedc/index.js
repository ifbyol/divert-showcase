...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DC says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dc server on %d", PORT);
});