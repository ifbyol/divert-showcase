...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EW says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ew server on %d", PORT);
});