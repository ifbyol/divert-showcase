...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BT says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bt server on %d", PORT);
});