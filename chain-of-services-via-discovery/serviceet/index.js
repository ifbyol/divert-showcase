...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service ET says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-et server on %d", PORT);
});