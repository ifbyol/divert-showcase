...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GG says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gg server on %d", PORT);
});