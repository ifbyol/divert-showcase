...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AM says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-am server on %d", PORT);
});