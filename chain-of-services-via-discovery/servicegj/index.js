...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GJ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gj server on %d", PORT);
});