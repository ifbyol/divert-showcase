...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service M says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-m server on %d", PORT);
});