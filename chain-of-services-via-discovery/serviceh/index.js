...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service H says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-h server on %d", PORT);
});