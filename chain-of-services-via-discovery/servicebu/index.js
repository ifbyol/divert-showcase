...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BU says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bu server on %d", PORT);
});