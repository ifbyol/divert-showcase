...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BO says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bo server on %d", PORT);
});