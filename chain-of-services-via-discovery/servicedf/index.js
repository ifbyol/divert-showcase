...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DF says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-df server on %d", PORT);
});