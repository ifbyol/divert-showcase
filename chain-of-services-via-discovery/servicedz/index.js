...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DZ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dz server on %d", PORT);
});