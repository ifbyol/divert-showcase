...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EF says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ef server on %d", PORT);
});