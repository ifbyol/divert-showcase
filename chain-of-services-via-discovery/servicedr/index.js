...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DR says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dr server on %d", PORT);
});