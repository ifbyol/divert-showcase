...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EE says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ee server on %d", PORT);
});