...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DJ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dj server on %d", PORT);
});