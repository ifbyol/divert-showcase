...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service P says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-p server on %d", PORT);
});