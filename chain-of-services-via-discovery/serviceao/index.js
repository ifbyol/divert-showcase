...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AO says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ao server on %d", PORT);
});