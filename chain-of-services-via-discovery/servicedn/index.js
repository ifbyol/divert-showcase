...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DN says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dn server on %d", PORT);
});