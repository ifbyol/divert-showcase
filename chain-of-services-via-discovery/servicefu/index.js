...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FU says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fu server on %d", PORT);
});