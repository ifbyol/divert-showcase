...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AP says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ap server on %d", PORT);
});