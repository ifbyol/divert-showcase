...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AE says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ae server on %d", PORT);
});