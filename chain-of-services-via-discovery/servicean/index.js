...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AN says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-an server on %d", PORT);
});