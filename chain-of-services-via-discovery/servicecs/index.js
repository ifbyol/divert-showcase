...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CS says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cs server on %d", PORT);
});