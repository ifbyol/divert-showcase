...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AY says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ay server on %d", PORT);
});