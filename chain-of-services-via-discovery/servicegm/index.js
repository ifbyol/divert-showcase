...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GM says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gm server on %d", PORT);
});