...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DI says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-di server on %d", PORT);
});