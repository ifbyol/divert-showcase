...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service ES says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-es server on %d", PORT);
});