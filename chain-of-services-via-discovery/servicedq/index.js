...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DQ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dq server on %d", PORT);
});