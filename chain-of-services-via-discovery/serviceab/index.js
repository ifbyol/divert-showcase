...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AB says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ab server on %d", PORT);
});