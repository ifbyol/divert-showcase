...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EN says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-en server on %d", PORT);
});