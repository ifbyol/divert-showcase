...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DG says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dg server on %d", PORT);
});