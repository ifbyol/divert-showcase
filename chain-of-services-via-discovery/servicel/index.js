...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service L says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-l server on %d", PORT);
});