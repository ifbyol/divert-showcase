...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GH says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gh server on %d", PORT);
});