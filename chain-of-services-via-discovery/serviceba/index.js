...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BA says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ba server on %d", PORT);
});