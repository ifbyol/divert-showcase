...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FW says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fw server on %d", PORT);
});