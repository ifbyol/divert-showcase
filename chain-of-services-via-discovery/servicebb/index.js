...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BB says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bb server on %d", PORT);
});