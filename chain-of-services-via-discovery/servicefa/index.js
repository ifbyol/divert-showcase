...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FA says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fa server on %d", PORT);
});