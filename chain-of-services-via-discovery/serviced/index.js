...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service D says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-d server on %d", PORT);
});