...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AC says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ac server on %d", PORT);
});