...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GF says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gf server on %d", PORT);
});