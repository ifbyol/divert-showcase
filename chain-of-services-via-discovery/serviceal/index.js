...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AL says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-al server on %d", PORT);
});