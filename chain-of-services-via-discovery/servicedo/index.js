...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DO says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-do server on %d", PORT);
});