...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CO says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-co server on %d", PORT);
});