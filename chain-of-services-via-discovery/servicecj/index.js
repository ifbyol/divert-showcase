...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CJ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cj server on %d", PORT);
});