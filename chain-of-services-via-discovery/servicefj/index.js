...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FJ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fj server on %d", PORT);
});