...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BM says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bm server on %d", PORT);
});