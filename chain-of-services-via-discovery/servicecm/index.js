...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CM says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cm server on %d", PORT);
});