...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EK says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ek server on %d", PORT);
});