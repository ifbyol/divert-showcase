...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AQ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-aq server on %d", PORT);
});