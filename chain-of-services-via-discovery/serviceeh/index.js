...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EH says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-eh server on %d", PORT);
});