...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BG says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bg server on %d", PORT);
});