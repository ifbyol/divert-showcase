...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EM says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-em server on %d", PORT);
});