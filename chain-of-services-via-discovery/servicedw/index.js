...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DW says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dw server on %d", PORT);
});