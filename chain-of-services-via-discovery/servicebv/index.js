...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BV says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bv server on %d", PORT);
});