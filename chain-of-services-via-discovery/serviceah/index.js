...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AH says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ah server on %d", PORT);
});