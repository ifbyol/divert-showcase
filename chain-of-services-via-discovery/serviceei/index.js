...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EI says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ei server on %d", PORT);
});