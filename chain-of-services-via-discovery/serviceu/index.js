...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service U says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-u server on %d", PORT);
});