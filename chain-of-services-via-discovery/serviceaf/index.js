...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AF says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-af server on %d", PORT);
});