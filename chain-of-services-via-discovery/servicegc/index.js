...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GC says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gc server on %d", PORT);
});