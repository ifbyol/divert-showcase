...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EB says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-eb server on %d", PORT);
});