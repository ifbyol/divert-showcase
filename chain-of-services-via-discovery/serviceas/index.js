...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AS says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-as server on %d", PORT);
});