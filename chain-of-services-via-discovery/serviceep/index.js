...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EP says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ep server on %d", PORT);
});