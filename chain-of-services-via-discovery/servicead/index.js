...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AD says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ad server on %d", PORT);
});