...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GQ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gq server on %d", PORT);
});