...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EX says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ex server on %d", PORT);
});