...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service ER says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-er server on %d", PORT);
});