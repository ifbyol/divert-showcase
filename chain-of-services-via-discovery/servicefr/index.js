...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FR says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fr server on %d", PORT);
});