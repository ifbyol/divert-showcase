...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DP says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dp server on %d", PORT);
});