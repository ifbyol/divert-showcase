...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FB says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fb server on %d", PORT);
});