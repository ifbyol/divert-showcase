...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BC says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bc server on %d", PORT);
});