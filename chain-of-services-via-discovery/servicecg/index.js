...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CG says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cg server on %d", PORT);
});