...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CI says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ci server on %d", PORT);
});