...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service K says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-k server on %d", PORT);
});