...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AV says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-av server on %d", PORT);
});