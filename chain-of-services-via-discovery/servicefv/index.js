...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FV says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fv server on %d", PORT);
});