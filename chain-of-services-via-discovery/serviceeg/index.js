...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EG says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-eg server on %d", PORT);
});