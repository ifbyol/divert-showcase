...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GL says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gl server on %d", PORT);
});