...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CC says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cc server on %d", PORT);
});