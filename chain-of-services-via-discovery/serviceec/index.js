...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EC says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ec server on %d", PORT);
});