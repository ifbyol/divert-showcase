...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DD says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dd server on %d", PORT);
});