...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CK says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ck server on %d", PORT);
});