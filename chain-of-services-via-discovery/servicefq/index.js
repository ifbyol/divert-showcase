...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FQ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fq server on %d", PORT);
});