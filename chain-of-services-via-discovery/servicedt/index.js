...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DT says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dt server on %d", PORT);
});