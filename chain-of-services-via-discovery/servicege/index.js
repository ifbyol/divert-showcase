...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GE says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ge server on %d", PORT);
});