...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BE says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-be server on %d", PORT);
});