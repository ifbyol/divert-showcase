...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AT says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-at server on %d", PORT);
});