...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CB says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cb server on %d", PORT);
});