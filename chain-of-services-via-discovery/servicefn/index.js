...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FN says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fn server on %d", PORT);
});