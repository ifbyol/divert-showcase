...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FL says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fl server on %d", PORT);
});