...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EU says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-eu server on %d", PORT);
});