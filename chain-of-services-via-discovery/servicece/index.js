...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CE says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ce server on %d", PORT);
});