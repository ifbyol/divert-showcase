...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service X says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-x server on %d", PORT);
});