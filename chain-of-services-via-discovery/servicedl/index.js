...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DL says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dl server on %d", PORT);
});