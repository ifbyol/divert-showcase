...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AZ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-az server on %d", PORT);
});