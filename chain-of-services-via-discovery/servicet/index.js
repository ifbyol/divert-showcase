...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service T says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-t server on %d", PORT);
});