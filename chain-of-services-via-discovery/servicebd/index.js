...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BD says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bd server on %d", PORT);
});