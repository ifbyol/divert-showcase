...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service EA says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ea server on %d", PORT);
});