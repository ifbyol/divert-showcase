...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service R says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-r server on %d", PORT);
});