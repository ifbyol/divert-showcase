...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service BZ says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-bz server on %d", PORT);
});