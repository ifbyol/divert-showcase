...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FM says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fm server on %d", PORT);
});