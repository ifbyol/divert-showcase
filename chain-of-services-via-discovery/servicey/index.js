...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service Y says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-y server on %d", PORT);
});