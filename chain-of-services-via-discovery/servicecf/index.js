...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CF says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cf server on %d", PORT);
});