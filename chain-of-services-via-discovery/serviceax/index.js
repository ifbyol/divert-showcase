...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AX says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ax server on %d", PORT);
});