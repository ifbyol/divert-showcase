...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service F says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-f server on %d", PORT);
});