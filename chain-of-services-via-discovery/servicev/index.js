...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service V says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-v server on %d", PORT);
});