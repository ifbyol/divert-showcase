...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FD says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fd server on %d", PORT);
});