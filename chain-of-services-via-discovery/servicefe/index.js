...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FE says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fe server on %d", PORT);
});