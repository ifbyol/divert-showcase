...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DY says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dy server on %d", PORT);
});