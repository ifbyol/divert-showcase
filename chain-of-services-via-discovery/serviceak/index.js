...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service AK says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-ak server on %d", PORT);
});