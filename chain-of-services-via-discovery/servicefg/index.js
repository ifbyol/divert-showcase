...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FG says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fg server on %d", PORT);
});