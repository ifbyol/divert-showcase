...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DK says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-dk server on %d", PORT);
});