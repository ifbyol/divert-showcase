...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service GB says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-gb server on %d", PORT);
});