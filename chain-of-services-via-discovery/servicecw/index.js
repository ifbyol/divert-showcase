...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service CW says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-cw server on %d", PORT);
});