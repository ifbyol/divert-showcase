...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service O says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-o server on %d", PORT);
});