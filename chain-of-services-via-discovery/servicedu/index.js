...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service DU says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-du server on %d", PORT);
});