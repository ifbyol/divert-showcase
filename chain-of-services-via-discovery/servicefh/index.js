...
app.get("/chain", async function (req, res) {
  ...
  try {
    ...
    const message = `Service FH says hello from ${process.env.OKTETO_NAMESPACE}! <br />`;
...
app.listen(PORT, function () {
  console.log("Started service-fh server on %d", PORT);
});